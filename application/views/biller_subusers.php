				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
							...
							<tbody>
								<?php foreach($biller_listing as $ul){?>
								<tr>
									...
									<td><a href="<?php echo site_url('biller/edit_subuser/'.$ul->id);?>" title="Edit Biller Subuser" alt = "Edit Biller Subuser"><i class="fa fa-fw fa-edit text-muted hidden-md hidden-sm hidden-xs"></i></a>
	   ...
	   <script type="text/javascript">
		function delete_user(uid)
		{
			if (confirm('Are You Sure to Delete this Record?')){
				window.location.href = 'biller/delete_billersubuser/' + uid;
			}
		}
		</script>
