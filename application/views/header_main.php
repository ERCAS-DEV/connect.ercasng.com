...
<html lang="en-us">
	<head>
		...
		<title>ERCAS Biller Module</title>
	...
	<body class="">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo"> <img src="<?php echo site_url('../uploads/biller_logo/'.$userdt[0]->company_logo);?>"> </span>
				<!-- END LOGO PLACEHOLDER -->

				<!-- Note: The activity badge color changes when clicked and resets the number to 0
				Suggestion: You may want to set a flag when this happens to tick off all checked messages / notifications -->
				<span id="activity" class="activity-dropdown"> <i class="fa fa-building"></i></span>
			...
			<div class="project-context hidden-xs">
				...
				<span class="label">ERCASConnect Client:</span>
				<span class="project-selector dropdown-toggle" data-toggle="dropdown"><?php echo strtoupper($userdt[0]->company_name);?></span>
