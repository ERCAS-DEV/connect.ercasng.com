		...
		<div class="row">
			<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
				<h1 class="page-title txt-color-blueDark">					
					<!-- PAGE HEADER -->
					<i class="fa-fw fa fa-pencil-square-o"></i>Approved Biller Configuration
				</h1>
			</div>
		</div>
		...
		<div class="row">	
			...
			<!-- Widget ID (each widget will need unique ID)-->
				...
				<header>
					...
					<h2>Approved Biller Configuration --- <b><?php echo $biller_detail[0]->name.'(Biller Id - '.$biller_detail[0]->id.')';?> </b></h2>
						...
						<section>
							<label class="select">&nbsp;&nbsp;Table for Configuration --&nbsp;&nbsp;
								<select class="input" name="services">
									...
									<option value="payment_collection_<?php echo $biller_detail[0]->biller_acronymn;?>">Choose Bank/Ebills Table</option>
									<?php }
									if($biller_services[0]->service_cashpoint =='1' ){?>	
									<option value="payment_pos_<?php echo $biller_detail[0]->biller_acronymn;?>">Choose CashPoint Table</option>
									<?php }
									if($biller_services[0]->service_centralpay_ecommerce =='1' ){?>	
									<option value="payment_ecommerce_<?php echo $biller_detail[0]->biller_acronymn;?>">Choose CentralPay/E-Commerce Table</option>
									<?php } ?>
								</select> <i></i> </label>								
