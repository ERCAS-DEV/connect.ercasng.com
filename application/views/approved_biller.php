						...
						<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td>Approved</td>
									<td><a href="<?php echo site_url('biller/edit_approved_biller/'.$ul->id);?>" title="Biller Detail" alt = "Biller Detail"><i class="fa fa-fw fa-edit text-muted hidden-md hidden-sm hidden-xs"></i></a>
