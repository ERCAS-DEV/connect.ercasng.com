...
<div id="main" role="main">
	...
	<div id="ribbon">
		...
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li>Home></li><li>Biller Management</li><li>Approve Biller Setup</li><li>For Approval</li>
		</ol>
	</div>
	<!-- END RIBBON -->
	<div id="content">
		<div class="row">
			<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
				<h1 class="page-title txt-color-blueDark">					
					<!-- PAGE HEADER -->
					<i class="fa-fw fa fa-pencil-square-o"></i>Biller Approval
				</h1>
			</div>
		</div>
		...
		<div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
			...
			<div>
				...
				<div class="widget-body no-padding">					
					<form id="smart-form-register" class="smart-form" method="post" action ="<?php echo site_url('biller/edit_biller/'.$biller_detail[0]->id);?>">
					<header>Approval form</header>						
						...
						<fieldset>	
							...
							<section>
								<label class="label">Approver's Comment</label>
								<label class="textarea">
									<textarea rows="3" class="custom-scroll" name="comment"></textarea> 
								</label>
							</section>
						</fieldset>
						<footer>
