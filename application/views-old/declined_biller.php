...
<div id="main" role="main">
	...
	<div id="ribbon">
		...
		<!-- breadcrumb -->
		<ol class="breadcrumb">
			<li>Home></li><li>Biller Management</li><li>Billers Account</li><li>Declined Billers Account</li>
		</ol>
	</div>
	<!-- END RIBBON -->
	<!-- MAIN CONTENT -->
		...
		<div class="row">
			<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
				<h1 class="page-title txt-color-blueDark">					
					<!-- PAGE HEADER -->
					<i class="fa-fw fa fa-pencil-square-o"></i>Declined Billers Listing
				</h1>
			</div>
		</div>
						...
						<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
							<thead>			                
								<tr>
									...
									<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Biller Company Name</th>
									...
									<th data-hide="phone,tablet"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Declined By</th>
							...
							<tbody>
								...
								<tr>
									...
									<td><?php $creatorId = $this->user_model->user_detail($ul->creatorId);	echo ucwords($creatorId[0]->first_name.' '.$creatorId[0]->last_name);
									?></td>
									<td><?php $approverId = $this->user_model->user_detail($ul->approverId);	echo ucwords($approverId[0]->first_name.' '.$approverId[0]->last_name);?></td>
									<td>Declined</td>
									<td><a href="<?php echo site_url('biller/edit_declined_biller/'.$ul->id);?>" title="Biller Detail" alt = "Biller Detail"><i class="fa fa-fw fa-edit text-muted hidden-md hidden-sm hidden-xs"></i></a>
									</td>
								</tr>
								<?php $i++;
								}?>
