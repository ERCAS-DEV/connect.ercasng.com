										...
										<div id="collapseTwo-1" class="panel-collapse collapse">
											<fieldset>
												<section>
													...
													<input type="checkbox" name="permissions[]" value="biller_account">
													<i></i>Create New Biller</label>
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller_approval">
													<i></i>Approve New Biller</label>
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller_configurations">
										...
										<div id="collapseTwo-2" class="panel-collapse collapse">
											<fieldset>
												<section>
													...
													<label class="checkbox">
														<input type="checkbox" name="permissions[]" value="users/edit_user">
										...
										<div id="collapseTwo-4" class="panel-collapse collapse">
											<fieldset>
												<section>
													<div class="col col-6" style="    margin-top: -18px;">
													<label class="checkbox">
														<input type="checkbox" name="permissions[]" value="biller_message">
														<i></i>Biller Messaging 
													</label>
													<label class="checkbox">
														<input type="checkbox" name="permissions[]" value="ercas_message">
														<i></i>ERCAS Messaging
													</label>
												</div>	
											</section>
										...
										<div id="collapseTwo-5" class="panel-collapse collapse">
											<fieldset>
												<section>
													<div class="col col-6" style="    margin-top: -18px;">
													<label class="checkbox">
														<input type="checkbox" name="permissions[]" value="biller_report_generate">
														<i></i>Search / Generate Biller Reports
													</label>
													<label class="checkbox">
														<input type="checkbox" name="permissions[]" value="graphic_analytics">
														<i></i>Graphic Analytics
													</label>
													<label class="checkbox">
														<input type="checkbox" name="permissions[]" value="management_reports">
														<i></i>Management Reports
													</label>
												</div>	
											</section>
										</fieldset>
										...
										<div id="collapseTwo-1" class="panel-collapse collapse">
											<fieldset>
												<section>
													<div class="col col-6" style="    margin-top: -18px;">
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller_account" <?php 
													if(in_array('biller_account',$perm)){ echo "checked";}
													?>>
													<i></i>Create New Biller</label>
													<label class="checkbox">
													<input type="checkbox" name="permissions[]" value="biller_approval" <?php 
													if(in_array('biller_approval',$perm)){ echo "checked";}
													?>>
													<i></i>Approve New Biller</label>
													<label class="checkbox">
														<input type="checkbox" name="permissions[]" value="biller_configuration" <?php 
													if(in_array('biller_configuration',$perm)){ echo "checked";}
													?>>
														<i></i>Biller Configurations
													</label>
												</div>	
										...
										<div id="collapseTwo-2" class="panel-collapse collapse">
											<fieldset>
												<section>
													...
													<label class="checkbox">
														<input type="checkbox" name="permissions[]" value="users/edit_user" <?php 
													if(in_array('users/edit_user',$perm)){ echo "checked";}
													?>>
														<i></i>Edit User Account
													</label>
												</div>	
										...
										<div id="collapseTwo-4" class="panel-collapse collapse">
											<fieldset>
												<section>
													<div class="col col-6" style="    margin-top: -18px;">
													<label class="checkbox">
														<input type="checkbox" name="permissions[]" value="biller_message" <?php 
													if(in_array('biller_message',$perm)){ echo "checked";}
													?>>
														<i></i>Biller Messaging 
													</label>
													<label class="checkbox">
										...
										<div id="collapseTwo-5" class="panel-collapse collapse">
											<fieldset>
												<section>
													<div class="col col-6" style="    margin-top: -18px;">
													<label class="checkbox">
														<input type="checkbox" name="permissions[]" value="biller_report_generate" <?php 
													if(in_array('biller_report_generate',$perm)){ echo "checked";}
													?>>
														<i></i>Search / Generate Biller Reports
													</label>
													<label class="checkbox">
														<input type="checkbox" name="permissions[]" value="graphic_analytics" <?php 
													if(in_array('graphic_analytics',$perm)){ echo "checked";}
													?>>
														<i></i>Graphic Analytics
													</label>
													<label class="checkbox">
														<input type="checkbox" name="permissions[]" value="management_reports" <?php 
													if(in_array('management_reports',$perm)){ echo "checked";}
													?>>
														<i></i>Management Reports
													</label>
												</div>	
